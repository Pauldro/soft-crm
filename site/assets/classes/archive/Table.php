...
class Table {
	...
	public function row ($align='', $bgcolor='') { // (across the board in every cell)
		$add = '';
		//if (!$this->rowOpen) $add .= $this->tableOpen;
		...
		if (!empty($align)) $this->rowAlign = $align;
		$this->rowOpen = true;
		$this->cellOpen = false;
		if (!empty($bgcolor)) $bgcolor = ' bgcolor="' . $bgcolor . '"';
		
		$this->tablestring .= $add . $this->indent() . '<tr' . $bgcolor . '>';
		//return $add . $this->indent() . '<tr' . $bgcolor . '>';
	}
	
	public function section($section) {
		$add = '';
		//if (!$this->sectionOpen) $add .= $this->tableOpen;
		$this->sectionOpen = true;
		$this->openSection = $section;
		
		$this->tablestring .= $add . $this->indent() . '<'.$section.'>';
		//return $add . $this->indent() . '<'.$section.'>';
	}
	...
	public function cell ($vars='', $content='&nbsp; ') {
		...
		//return $add . $this->indent() . '<td' . $this->values($vars) . '>' . $content;
	}
	...
	public function headercell ($vars='', $content='') {
		...
		//return $add . $this->indent() . '<th' . $this->values($vars) . '>' . $content;
	}
