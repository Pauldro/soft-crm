	...
	urls: {
		...
		customer: {
			...
			redir: {
                ...
                ci_orderdocuments: sitepath + "customers/redir/?action=get-order-documents",
				ci_paymenthistory: sitepath + "customers/redir/?action=ci-payment-history",
			...
			load: {
                ...
                ci_orderdocuments: sitepath + "ajax/load/ci/ci-order-documents/",
