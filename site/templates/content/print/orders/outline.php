	...
	<div class="col-xs-3">
		<table class="table table-condensed pull-right">
			<tr>
				...
				<td class="text-right col-xs-6">$ <?= $page->stringerbell->format_money($order->subtotal); ?></td>
			</tr>
			<tr>
				<td class="col-xs-6"><label>Tax</label></td> 
				<td class="text-right col-xs-6">$ <?= $page->stringerbell->format_money($order->salestax); ?></td>
			</tr>
			<tr>
				<td class="col-xs-6"><label>Freight</label></td> 
				<td class="text-right col-xs-6">$ <?= $page->stringerbell->format_money($order->freight); ?></td>
			</tr>
			<tr>
				<td class="col-xs-6"><label>Misc.</label></td> 
				<td class="text-right col-xs-6">$ <?= $page->stringerbell->format_money($order->misccost); ?></td>
			</tr>
			<tr class="active">
				<td class="col-xs-6"><label>Total</label></td> 
				<td class="text-right col-xs-6">$ <?= $page->stringerbell->format_money($order->ordertotal); ?></td>
			</tr>
		</table>
	</div>
</div>
