<?php
    ...
    $pageurl->path = ($input->get->text('q')) ? $pageurl->path : $config->pages->ajaxload."customers/cust-index/";
    $pageurl->query->set('function', 'ajax-choose');
