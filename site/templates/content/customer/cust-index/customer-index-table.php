			...
			<?php if ($resultscount > 0) : ?>
				...
				<?php foreach ($customer_records as $cust) : ?>
					<tr>
						...
						<td><a href="<?= $config->dplusoURLS->get_customer_contactURL($contact->custid, $contact->shiptoid, $contact->contact); ?>"><?= $page->bootstrap->highlight($cust->contact, $input->get->q); ?></a></td>
