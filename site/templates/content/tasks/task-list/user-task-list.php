<?php
	$tasks = get_linked_tasks($user->loginid, '', '', '', '', '', '', $taskpanel->completed, $config->showonpage, $input->pageNum(), false);
?>
<table class="table table-bordered table-condensed table-striped">
	<thead>
    	<tr> <th>Due</th> <th>CustID</th> <th>Note</th> <th>View Task</th>  <th>Mark as Complete</th>  </tr>
    </thead>
    <tbody>
