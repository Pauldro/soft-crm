        ...
        <?php else : ?>
            ...
            <div class="product-info">
                <ul class="nav nav-tabs nav_tabs hidden-print">
                    ...
                    <li><a href="#<?= $item['itemid']; ?>-pricing-tab" data-toggle="tab" aria-expanded="false">Pricings</a></li>
                    <?php if ($linedetail['kititemflag'] == 'Y') : ?>
                        <li><a href="#<?= $item['itemid']; ?>-components-tab" data-toggle="tab" aria-expanded="false">Kit Components</a></li>
                    <?php endif; ?>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="<?= $item['itemid']; ?>-pricing-tab"><br><?php include $config->paths->content."products/product-results/price-structure.php"; ?></div>
                    <div class="tab-pane fade" id="<?= $item['itemid']; ?>-components-tab"><br><?php include $config->paths->content."products/product-results/kit-components.php"; ?></div>
                </div>
            </div>
        <?php endif; ?>
    </div>
