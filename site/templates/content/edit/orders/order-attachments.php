<div class="text-center form-group hidden-xs">
	<div class="btn-group" role="group" aria-label="View Order Attachments">
		...
		<?php if ($order->has_documents()) : ?>
			<a href="<?= $this->generate_documentsrequestURL($order); ?>" class="btn btn-primary load-sales-docs" title="View Documents" data-loadinto=".docs" data-focus=".docs" data-click="#documents-link">
...
<div class="text-center form-group hidden-sm hidden-md hidden-lg">
	<div class="btn-group-vertical" role="group" aria-label="View Order Attachments">
		...
		<!--  Documents Link -->
		<?php if ($order->has_documents()) : ?>
			<a href="<?= $orderpanel->generate_documentsrequestURL($order, $detail); ?>" class="btn btn-default load-sales-docs" title="View Documents" data-loadinto=".docs" data-focus=".docs" data-click="#documents-link">
