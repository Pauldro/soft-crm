<form action="<?= $config->pages->quotes.'redir/'; ?>" method="post" class="quick-entry-add allow-enterkey-submit" id="quick-entry-add" data-validated="">
	...
	<div class="row">
		<div class="col-xs-9 sm-padding">
			...
			<div class="col-md-2 form-group text-right sm-padding">
				<a href="<?= $config->pages->ajax."load/products/non-stock/form/quote/?qnbr=$quote->quotnbr&page=".$page->fullURL->getUrl(); ?>" class="btn btn-sm btn-primary load-into-modal nonstock-btn" data-modal="#ajax-modal" data-modalsize="xl">
