<?php
    ...
    $config->pages->editquote               = $config->dplusoURLS->find('edit_quote');
    $config->pages->orderquote              = $config->dplusoURLS->find('edit_orderquote');
    $config->pages->confirmorder            = $config->urls->root . 'edit/order/confirm/';
    $config->pages->confirmquote            = $config->dplusoURLS->find('confirm_quote');
    ...
    $config->pages->quotes                  = $config->dplusoURLS->find('quotes');
	...
	$config->pages->inventory_printitemlabel = $config->urls->root . "warehouse/inventory/print-item-label/";
